...
def test_subscription_does_not_dilute_existing_lps(wire):
    ...
    nav_before = wire.nav.compute().nav_per_unit
    ...
    assert wire.nav.compute().nav_per_unit == pytest.approx(nav_before)
...
def test_full_redemption_is_nav_neutral(wire):
    ...
    navpu = wire.nav.compute().nav_per_unit
    ...
    assert wire.nav.compute().nav_per_unit == pytest.approx(navpu)  # neutral
