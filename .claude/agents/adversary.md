...
> Verdicts RIGHT in both directions: kills that stayed killed AND survives that survived downstream review. A kill count alone is the exact metric the north star forbids — the kills serve the money.
