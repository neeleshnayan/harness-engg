...
@dataclass
class Book:
    cash: float = 0.0                                   # USD, idle
    units_outstanding: float = 0.0                      # fund units issued to LPs
