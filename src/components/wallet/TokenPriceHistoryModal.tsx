                ...
                {currentPrice && (
                  <div className="mt-2 flex items-center gap-3">
                    ...
                    {priceChange && Math.abs(priceChange.percentChange) >= 0.01 && (
                      <p className={`text-sm font-medium ${priceChange.percentChange >= 0 ? 'text-emerald-400' : 'text-red-400'
                        }`}>
              ...
              <div className="flex items-center justify-center h-full px-4 py-8">
                <div className="flex flex-col items-center gap-4">
                  <div className="relative">
                    <div className="animate-spin rounded-full h-10 w-10 border-2 border-zinc-700 border-t-[hsl(var(--brand-accent))]"></div>
                    <div className="absolute inset-0 animate-ping rounded-full h-10 w-10 border border-[hsl(var(--brand-accent))]/20"></div>
                  </div>
