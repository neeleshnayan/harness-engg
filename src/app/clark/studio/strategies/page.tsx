...
export default function StrategiesPage() {
  const [theme, setTheme] = useState<"dark" | "light">("light"); // Default to Anthropic Pastel Light Mode
...
`;
  ...
  return (
    <div className={`min-h-screen transition-colors ${
      isLight ? "bg-[#FBF9F5] text-[#2D2B2A]" : "bg-[#050811] text-zinc-100"
    } font-sans selection:bg-teal-500/30`}>
      {/* Studio Header Subnav with Theme Switcher */}
      <div className="relative">
        ...
        <div className="absolute top-4 right-6 z-50">
          <button
            ...
            className={`flex items-center gap-2 px-3.5 py-1.5 rounded-xl text-xs font-mono font-bold transition-all shadow-md cursor-pointer border ${
              isLight
                ? "bg-[#F0EBE1] text-[#1E1E1E] border-[#D9D2C5] hover:bg-[#E2DDD2]"
                : "bg-[#0C152B] text-teal-300 border-teal-500/40 hover:bg-teal-950"
            }`}
          >
            {isLight ? (
              <>
              ...
              <>
                ...
                <span>Institutional Dark Mode 🌙</span>
              </>
            )}
          </button>
        </div>
      ...
      <div className="mx-auto max-w-[1600px] px-6 py-6 space-y-6">
        ...
        {loading ? (
          <div className={`flex flex-col items-center justify-center py-28 gap-3 rounded-2xl border ${
            isLight ? "bg-[#FAF8F5] border-[#EAE5D9] text-[#78716C]" : "bg-[#0B101D]/40 border-zinc-800 text-zinc-400"
          }`}>
            <Loader2 className={`animate-spin ${isLight ? "text-[#D97757]" : "text-teal-400"}`} size={36} />
            <span className="text-xs font-mono">Loading fund strategy trees & quant environments...</span>
          </div>
        ) : strategies.length === 0 ? (
          <div className={`flex flex-col items-center justify-center py-20 text-sm rounded-2xl border ${
            isLight ? "bg-[#FAF8F5] border-[#EAE5D9] text-[#78716C]" : "bg-zinc-900/40 border-zinc-800 text-zinc-500"
          }`}>
          ...
          <>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 font-mono">
              <div className={`p-5 rounded-2xl border shadow-xl backdrop-blur-md space-y-1.5 ${
                isLight ? "bg-[#FAF8F5] border-[#EAE5D9]" : "bg-gradient-to-br from-[#0C1935]/90 to-[#070E20]/90 border-teal-500/30"
              }`}>
                <div className={`flex items-center justify-between text-xs font-bold uppercase tracking-wider ${
                  isLight ? "text-[#78716C]" : "text-zinc-400"
                }`}>
                  <span>Strategy Models Count</span>
                  <Layers size={16} className={isLight ? "text-[#D97757]" : "text-teal-400"} />
                </div>
                <div className="flex items-baseline gap-2">
                  <span className={`text-2xl font-black ${isLight ? "text-[#1E1E1E]" : "text-white"}`}>
                    {strategies.length} Total
                  </span>
                  <span className={`text-xs font-bold ${isLight ? "text-[#276749]" : "text-emerald-400"}`}>
                    ({deployedCount} Deployed | {draftCount} Drafts)
                  </span>
                </div>
                <p className={`text-[10px] ${isLight ? "text-[#A8A29E]" : "text-zinc-500"}`}>
                  Live venue & sandbox quantitative algorithms
                </p>
              </div>
              ...
              <div className={`p-5 rounded-2xl border shadow-xl backdrop-blur-md space-y-1.5 ${
                ...
                <div className="flex items-baseline gap-2">
                  ...
                  <span className={`text-xs font-bold ${isLight ? "text-[#D97757]" : "text-teal-300"}`}>
                    21.2% NAV
                  </span>
                </div>
                <p className={`text-[10px] ${isLight ? "text-[#A8A29E]" : "text-zinc-500"}`}>
                  Active capital committed on Alpaca venue
                </p>
              </div>

              <div className={`p-5 rounded-2xl border shadow-xl backdrop-blur-md space-y-1.5 ${
                isLight ? "bg-[#FAF8F5] border-[#EAE5D9]" : "bg-gradient-to-br from-[#0A2020]/90 to-[#070E20]/90 border-emerald-500/30"
              }`}>
                <div className={`flex items-center justify-between text-xs font-bold uppercase tracking-wider ${
                  isLight ? "text-[#78716C]" : "text-zinc-400"
                }`}>
                ...
                <div className="flex items-baseline gap-2">
                  <span className={`text-2xl font-black ${
                    totalPnl >= 0 ? (isLight ? "text-[#276749]" : "text-emerald-400") : "text-rose-400"
                  }`}>
                ...
                <p className={`text-[10px] ${isLight ? "text-[#A8A29E]" : "text-zinc-500"}`}>
                  Realized + unrealized strategy yield
                </p>
              </div>
              ...
              <div className={`p-5 rounded-2xl border shadow-xl backdrop-blur-md space-y-1.5 ${
                ...
                <div className={`flex items-center justify-between text-xs font-bold uppercase tracking-wider ${
                  ...
                  <ShieldCheck size={16} className={isLight ? "text-[#D97757]" : "text-teal-400"} />
                </div>
                <div className="flex items-baseline gap-2">
                  <span className={`text-2xl font-black ${isLight ? "text-[#D97757]" : "text-teal-300"}`}>
                    2.35 Sharpe
                  </span>
                  <span className={`text-xs font-bold px-2 py-0.5 rounded border ${
                    isLight ? "bg-[#E8F0EC] text-[#276749] border-[#C3DCD0]" : "bg-emerald-950/80 text-emerald-400 border-emerald-700/60"
                  }`}>
                    PASSING
                  </span>
                </div>
                <p className={`text-[10px] ${isLight ? "text-[#A8A29E]" : "text-zinc-500"}`}>
                  Deterministic risk & drawdown controls
                </p>
              </div>
            </div>
            ...
            <div className={`flex items-center justify-between border-b pb-3 pt-2 ${
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className={`flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs font-mono font-bold transition-all cursor-pointer ${
                    subTab === "overview"
                      ? (isLight ? "bg-[#D97757] text-white shadow-md" : "bg-gradient-to-r from-teal-500 to-emerald-500 text-zinc-950 shadow-lg shadow-teal-500/20")
                      : (isLight ? "bg-[#F0EBE1] text-[#44403C] hover:bg-[#E4DDD0] border border-[#D9D2C5]" : "bg-[#090F1E] text-zinc-400 hover:text-white hover:bg-zinc-800 border border-teal-900/30")
                  }`}
                >
                  <PieChart size={15} />
                ...
                >
                  ...
                  <span className={`text-[9px] font-extrabold px-2 py-0.5 rounded border ${
                    isLight ? "bg-[#E8F0EC] text-[#276749] border-[#C3DCD0]" : "bg-teal-950 text-teal-300 border-teal-700/50"
                  }`}>
                    HYBRID PRO
                  </span>
                </button>
              ...
              <Button
                ...
                className={isLight ? "bg-[#276749] hover:bg-[#1E523A] text-white font-bold text-xs h-9 px-4 rounded-xl cursor-pointer" : "bg-teal-950/80 hover:bg-teal-900/80 border border-teal-500/40 text-teal-300 font-bold text-xs h-9 px-4 rounded-xl cursor-pointer"}
              >
            ...
            {subTab === "overview" && (
              <div className="space-y-6">
                ...
                <div className={`rounded-2xl border p-6 shadow-2xl backdrop-blur-md space-y-4 font-mono ${
                  isLight ? "bg-[#FAF8F5] border-[#EAE5D9]" : "bg-[#080E1B]/95 border-emerald-500/30"
                }`}>
                  <div className={`flex items-center justify-between border-b pb-4 ${
                    ...
                    <div className="flex items-center gap-3">
                      <div className={`p-2.5 rounded-xl border ${
                        isLight ? "bg-[#E8F0EC] text-[#276749] border-[#C3DCD0]" : "bg-emerald-500/10 text-emerald-400 border-emerald-500/30"
                      }`}>
                        <Flame size={20} />
                      </div>
                      <div>
                    ...
                    <span className={`text-xs px-3 py-1 rounded-lg border font-bold ${
                      isLight ? "bg-[#E8F0EC] text-[#276749] border-[#C3DCD0]" : "bg-emerald-950/80 text-emerald-400 border-emerald-700/60"
                    }`}>
                    ...
                    <table className="w-full text-left text-xs">
                      <thead>
                        <tr className={`border-b text-[10px] uppercase tracking-wider ${
                          isLight ? "border-[#EAE5D9] text-[#78716C]" : "border-teal-900/40 text-zinc-400"
                        }`}>
                          ...
                          return (
                            <tr
                              ...
                              className={`transition-all ${
                                isSelected
                                  ? (isLight ? "bg-[#F3EFE6]" : "bg-teal-950/40")
                                  : (isLight ? "hover:bg-[#F8F4EC]" : "hover:bg-teal-950/30")
                              }`}
                            >
                              <td className={`py-4 font-bold flex items-center gap-2 ${isLight ? "text-[#1E1E1E]" : "text-white"}`}>
                                <span className={`w-2 h-2 rounded-full animate-pulse ${isLight ? "bg-[#276749]" : "bg-emerald-400"}`} />
                                {s.name}
                              </td>

                              <td>
                                <span className={`text-[10px] uppercase font-bold px-2 py-0.5 rounded border ${
                                  isLight ? "bg-[#E8F0EC] text-[#276749] border-[#C3DCD0]" : "bg-emerald-500/15 text-emerald-300 border-emerald-500/30"
                                }`}>
                                  {s.state}
                                </span>
                              </td>
                              ...
                              <td className="w-[200px]">
                                <div className="space-y-1">
                                  <div className={`flex justify-between text-[10px] font-mono ${isLight ? "text-[#78716C]" : "text-zinc-400"}`}>
                                    <span>Actual: <strong className={isLight ? "text-[#D97757]" : "text-teal-300"}>{pct(s.actual_pct)}</strong></span>
                                  ...
                                  <div className={`relative h-1.5 rounded-full overflow-hidden border ${
                                    ...
                                    <div
                                      className={`h-full rounded-full ${isLight ? "bg-[#D97757]" : "bg-gradient-to-r from-teal-500 to-emerald-400"}`}
                                      style={{ width: `${actual}%` }}
                                    />
                                    <div
                                      className="absolute -top-0.5 h-2.5 w-0.5 bg-[#1E1E1E] shadow-md rounded"
                                      style={{ left: `${target}%` }}
                                    />
                                  </div>
                                </div>
                              ...
                              <td className={`text-right font-bold ${isLight ? "text-[#2D2B2A]" : "text-zinc-200"}`}>{money(s.exposure_usd)}</td>

                              <td className={`text-right font-bold ${up ? (isLight ? "text-[#276749]" : "text-emerald-400") : "text-rose-500"}`}>
                                {up ? "+" : ""}{money(pnl)}
                              </td>
                                  ...
                                  {(s.assets || ["AAPL", "MSFT"]).map((sym) => (
                                    <span
                                      ...
                                      className={`text-[9px] font-bold px-2 py-0.5 rounded border ${
                                        isLight ? "bg-[#F0EBE1] text-[#D97757] border-[#D9D2C5]" : "bg-teal-950 text-teal-300 border border-teal-700/40"
                                      }`}
                                    >
                                      {sym}
                                    </span>
                              ...
                              <td className="text-center">
                                <div className="flex items-center justify-center gap-2">
                                  <Button
                                    ...
                                    className={isLight ? "bg-[#D97757] hover:bg-[#C26243] text-white font-bold text-[11px] h-7 px-2.5 rounded-lg cursor-pointer" : "bg-teal-950 hover:bg-teal-900 text-teal-300 border border-teal-500/40 text-[11px] font-bold h-7 px-2.5 rounded-lg cursor-pointer"}
                                  >
                                  ...
                                  <Button
                                    ...
                                    className={isLight ? "bg-[#EAE5D9] hover:bg-[#D9D2C5] text-[#44403C] text-[11px] font-bold h-7 px-2 rounded-lg cursor-pointer" : "bg-zinc-900 hover:bg-zinc-800 text-zinc-400 border border-zinc-800 text-[11px] font-bold h-7 px-2 rounded-lg cursor-pointer"}
                ...
                <div className={`rounded-2xl border p-6 shadow-2xl backdrop-blur-md space-y-4 font-mono ${
                  isLight ? "bg-[#FAF8F5] border-[#EAE5D9]" : "bg-[#080E1B]/95 border-teal-900/40"
                }`}>
                  <div className={`flex items-center justify-between border-b pb-4 ${
                    isLight ? "border-[#EAE5D9]" : "border-teal-900/40"
                  }`}>
                    <div className="flex items-center gap-3">
                      <div className={`p-2.5 rounded-xl border ${
                        isLight ? "bg-[#F0EBE1] text-[#D97757] border-[#D9D2C5]" : "bg-teal-500/10 text-teal-400 border-teal-500/30"
                      }`}>
                        <Layers size={20} />
                      </div>
                      <div>
                    ...
                    <Button
                      size="sm"
                      onClick={createSandbox}
                      className={isLight ? "bg-[#276749] text-white font-extrabold text-xs h-8 px-4 rounded-xl cursor-pointer" : "bg-gradient-to-r from-teal-500 to-emerald-500 text-zinc-950 font-extrabold text-xs h-8 px-4 rounded-xl cursor-pointer"}
                    >
                            ...
                            >
                              ...
                              <td>
                                <span className={`text-[9px] uppercase font-bold px-2 py-0.5 rounded border ${
                                  isLight ? "bg-[#F0EBE1] text-[#78716C] border-[#D9D2C5]" : STATE_STYLE[s.state] || STATE_STYLE.draft
                                }`}>
                                  {s.state}
                                </span>
                              </td>

                              <td className={`font-mono font-bold ${isLight ? "text-[#D97757]" : "text-teal-300"}`}>{pct(s.allocation_pct)}</td>
                              ...
                              <td className="text-center">
                                <div className="flex items-center justify-center gap-2">
                                  <Button
                                    ...
                                    disabled={deployBusy}
                                    className={isLight ? "bg-[#276749] text-white font-bold text-[11px] h-7 px-3 rounded-lg cursor-pointer" : "bg-gradient-to-r from-teal-500 to-emerald-500 text-zinc-950 font-extrabold text-[11px] h-7 px-3 rounded-lg shadow-md cursor-pointer"}
                                  >
                                  ...
                                  <Button
                                    ...
                                    className={isLight ? "bg-[#D97757] text-white font-bold text-[11px] h-7 px-2.5 rounded-lg cursor-pointer" : "bg-teal-950 hover:bg-teal-900 text-teal-300 border border-teal-500/40 text-[11px] font-bold h-7 px-2.5 rounded-lg cursor-pointer"}
                                  >
                                    <Code2 size={12} className="mr-1" />
                                    Edit Python
                                  </Button>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                  ...
                  <div className={`lg:col-span-6 rounded-2xl border p-6 shadow-xl backdrop-blur-md ${
                    isLight ? "bg-[#FAF8F5] border-[#EAE5D9]" : "bg-[#090F1E]/90 border-teal-900/40"
                  }`}>
                    <div className={`flex items-center justify-between border-b pb-4 mb-4 ${
                      isLight ? "border-[#EAE5D9]" : "border-teal-900/30"
                    }`}>
                      <div className="flex items-center gap-2 font-mono">
                        <PieChart size={18} className={isLight ? "text-[#D97757]" : "text-teal-400"} />
                      ...
                      <span className={`text-xs font-mono ${isLight ? "text-[#78716C]" : "text-zinc-400"}`}>Capital Weights</span>
                    </div>
                  ...
                  <div className={`lg:col-span-6 rounded-2xl border p-6 shadow-xl backdrop-blur-md space-y-4 font-mono ${
                    isLight ? "bg-[#FAF8F5] border-[#EAE5D9]" : "bg-[#090F1E]/90 border-teal-900/40"
                  }`}>
                    <div className={`flex items-center justify-between border-b pb-4 ${
                      isLight ? "border-[#EAE5D9]" : "border-teal-900/30"
                      ...
                      <div className="flex items-center gap-2">
                        <Target size={18} className={isLight ? "text-[#D97757]" : "text-teal-400"} />
                        <div>
                          ...
                          <span className={`text-[10px] ${isLight ? "text-[#78716C]" : "text-zinc-400"}`}>
                            Active Workspace: {strat?.name || "Selected"}
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center gap-2">
                        <select
                          ...
                          className={`text-xs font-bold rounded-lg px-2.5 py-1 border outline-none ${
                            isLight ? "bg-[#F0EBE1] text-[#1E1E1E] border-[#D9D2C5]" : "bg-zinc-950 text-teal-300 border-zinc-800"
                          }`}
                        >
                        ...
                        <Button
                          ...
                          disabled={optRunning}
                          className={isLight ? "bg-[#D97757] text-white font-bold text-xs h-7 px-3 cursor-pointer" : "bg-gradient-to-r from-teal-500 to-emerald-500 text-zinc-950 font-bold text-xs h-7 px-3 cursor-pointer"}
                        >
                    ...
                    {optResponse && (
                      <div className={`p-3.5 rounded-xl border text-xs font-mono space-y-2 ${
                        isLight ? "bg-[#F3EFE6] border-[#D9D2C5]" : "bg-teal-950/40 border-teal-500/30"
                      }`}>
                        <div className="flex items-center justify-between">
                          <span className={`font-bold ${isLight ? "text-[#276749]" : "text-emerald-300"}`}>Optimal Weights ({optMethod}):</span>
                          <Button
                            size="sm"
                            onClick={applyOptimalWeights}
                            className={isLight ? "bg-[#276749] text-white font-bold text-[10px] h-6 px-2.5 rounded shadow cursor-pointer" : "bg-gradient-to-r from-emerald-500 to-teal-500 text-zinc-950 font-extrabold text-[10px] h-6 px-2.5 rounded shadow cursor-pointer"}
                          >
                        ...
                        <div className="grid grid-cols-3 gap-2 text-zinc-300">
                          {Object.entries(optResponse.weights || {}).map(([sym, w]) => (
                            <div key={sym} className={`flex justify-between p-1.5 rounded-lg border ${
                              isLight ? "bg-[#FAF8F5] text-[#1E1E1E] border-[#EAE5D9]" : "bg-zinc-950/60 text-zinc-300 border-zinc-800"
                            }`}>
                              <span>{sym}:</span>
                              <strong className={isLight ? "text-[#D97757]" : "text-teal-300"}>{(Number(w) * 100).toFixed(1)}%</strong>
                            </div>
                          ))}
                        </div>
                      </div>
            ...
            {subTab === "ide" && strat && (
              <div className={`rounded-2xl border p-6 shadow-2xl space-y-6 font-mono ${
                isLight ? "bg-[#FAF8F5] border-[#EAE5D9]" : "bg-[#040812] border-teal-500/40"
              }`}>
                    ...
                    <div>
                      <div className="flex items-center gap-3">
                        ...
                        <span className={`flex items-center gap-1.5 px-3 py-0.5 rounded-full border text-xs font-bold ${
                          isLight ? "bg-[#E8F0EC] text-[#276749] border-[#C3DCD0]" : "bg-emerald-500/15 text-emerald-300 border-emerald-500/40"
                        }`}>
                      ...
                      <p className={`text-xs mt-0.5 ${isLight ? "text-[#78716C]" : "text-zinc-400"}`}>
                        TradingView price action & signal markers bound to <strong className={isLight ? "text-[#D97757]" : "text-teal-300"}>{strat.name}</strong> (LEAN Engine 3.11 Python AST)
                      </p>
                    </div>
                  </div>
                      ...
                      return (
                        <button
                          ...
                          className={`px-3 py-1 rounded-lg text-xs font-bold transition-all border cursor-pointer ${
                            active
                              ? (isLight ? "bg-[#D97757] text-white border-[#C26243]" : "bg-gradient-to-r from-teal-500 to-emerald-500 text-zinc-950 border-teal-400 shadow-md")
                              : (isLight ? "bg-[#F0EBE1] text-[#44403C] border-[#D9D2C5] hover:bg-[#E2DDD2]" : "bg-zinc-950/80 text-zinc-300 border-zinc-800 hover:border-teal-700/50 hover:text-white")
                          }`}
                        >
                          {preset.name}
                        </button>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                  ...
                  <div className="lg:col-span-3 space-y-4">
                    ...
                    <div className={`rounded-xl border p-4 space-y-3 ${
                      isLight ? "bg-[#F3EFE6] border-[#D9D2C5]" : "bg-[#070D1A] border-teal-900/40"
                    }`}>
                      <div className={`flex items-center justify-between border-b pb-2 ${
                        isLight ? "border-[#D9D2C5]" : "border-teal-900/30"
                      }`}>
                        <span className={`text-xs font-bold uppercase ${isLight ? "text-[#1E1E1E]" : "text-zinc-300"}`}>TradingView Watchlist</span>
                        <span className={`text-[10px] font-bold ${isLight ? "text-[#D97757]" : "text-teal-400"}`}>{assets.length} Tickers</span>
                      </div>
                          ...
                          return (
                            <button
                              ...
                              className={`w-full flex items-center justify-between py-2 px-3 rounded-lg border text-xs font-bold transition cursor-pointer ${
                                isTarget
                                  ? (isLight ? "bg-[#E8F0EC] border-[#C3DCD0] text-[#276749]" : "bg-teal-950/80 border-teal-500/60 text-teal-300 shadow-md")
                                  : (isLight ? "bg-[#FAF8F5] border-[#EAE5D9] text-[#44403C] hover:bg-[#F0EBE1]" : "bg-zinc-950/40 border-zinc-800 text-zinc-400 hover:text-white hover:bg-zinc-900")
                              }`}
                            >
                              <span className="font-mono">{sym}</span>
                              {isTarget ? (
                                <span className={`text-[9px] px-1.5 py-0.5 rounded border font-bold ${
                                  isLight ? "bg-[#E8F0EC] text-[#276749] border-[#C3DCD0]" : "bg-emerald-950 text-emerald-300 border border-emerald-800"
                                }`}>
                                  TARGET 🟢
                                </span>
                              ) : (
                      ...
                      <div className="flex gap-1.5 pt-1">
                        <Input
                          ...
                          className={isLight ? "bg-[#FAF8F5] border-[#D9D2C5] text-xs font-mono text-[#1E1E1E] h-8" : "bg-zinc-950 border-zinc-800 text-xs font-mono text-teal-300 h-8"}
                        />
                        <Button size="sm" onClick={addAsset} disabled={addBusy || !addSym.trim()} className={isLight ? "h-8 px-2.5 bg-[#D97757] text-white cursor-pointer" : "h-8 px-2.5 bg-teal-500 text-zinc-950 cursor-pointer"}>
                          <Plus size={14} />
                        </Button>
                      </div>
                    </div>
                    ...
                    <div className={`rounded-xl border p-4 space-y-3 ${
                      ...
                      <span className={`text-xs font-bold uppercase block border-b pb-2 ${
                        isLight ? "text-[#1E1E1E] border-[#D9D2C5]" : "text-zinc-300 border-teal-900/30"
                      }`}>
                      ...
                      <div className="space-y-2 text-xs">
                        <div>
                          ...
                          <select
                            ...
                            className={`w-full h-8 rounded-lg border px-2 text-xs font-bold outline-none cursor-pointer ${
                              isLight ? "bg-[#FAF8F5] text-[#1E1E1E] border-[#D9D2C5]" : "bg-zinc-950 text-teal-300 border-zinc-800"
                            }`}
                          >
                            {assets.map((sym) => (
                        ...
                        <div className="pt-2 space-y-2">
                          <Button
                            ...
                            disabled={btRunning}
                            className={isLight ? "w-full bg-[#276749] hover:bg-[#1E523A] text-white font-extrabold text-xs h-9 rounded-xl shadow cursor-pointer" : "w-full bg-gradient-to-r from-teal-500 to-emerald-500 text-zinc-950 font-extrabold text-xs h-9 rounded-xl shadow-lg cursor-pointer"}
                          >
                          ...
                          <Button
                            ...
                            className={isLight ? "w-full bg-[#D97757] hover:bg-[#C26243] text-white font-extrabold text-xs h-9 rounded-xl cursor-pointer" : "w-full bg-zinc-900 hover:bg-teal-950/80 border border-teal-500/40 text-teal-300 font-extrabold text-xs h-9 rounded-xl cursor-pointer"}
                          >
                            {deployBusy ? <Loader2 size={14} className="animate-spin mr-1.5" /> : <Rocket size={14} className="mr-1.5" />}
                  ...
                  <div className="lg:col-span-9 space-y-5">
                    ...
                    <div className={`p-3.5 rounded-xl border shadow-xl space-y-2 ${
                      isLight ? "bg-[#F3EFE6] border-[#D9D2C5]" : "bg-gradient-to-r from-[#0D1B36] via-[#091428] to-[#0D1B36] border-teal-500/40"
                    }`}>
                      <div className={`flex items-center gap-2 text-xs font-bold ${isLight ? "text-[#D97757]" : "text-teal-300"}`}>
                        <Bot size={16} className={`animate-bounce ${isLight ? "text-[#D97757]" : "text-teal-400"}`} />
                      ...
                      <div className="flex flex-col sm:flex-row gap-2">
                        <Input
                          ...
                          className={isLight ? "bg-[#FAF8F5] border-[#D9D2C5] text-xs font-mono text-[#1E1E1E] placeholder:text-[#A8A29E] flex-1 h-9" : "bg-zinc-950 border-zinc-800 text-xs font-mono text-white placeholder:text-zinc-500 flex-1 h-9"}
                        />

                        <Button
                          onClick={() => generateCodeWithClark()}
                          disabled={aiGenerating || !aiPrompt.trim()}
                          className={isLight ? "bg-[#D97757] text-white font-extrabold text-xs h-9 px-5 rounded-lg cursor-pointer" : "bg-gradient-to-r from-teal-500 to-emerald-500 text-zinc-950 font-extrabold text-xs h-9 px-5 rounded-lg shadow-md cursor-pointer"}
                        >
                    ...
                    <div className={`rounded-xl border overflow-hidden shadow-2xl ${
                      isLight ? "bg-[#FAF8F5] border-[#EAE5D9]" : "bg-[#040813] border-teal-900/50"
                    }`}>
                      <div className={`flex items-center justify-between px-3 py-2 border-b text-xs ${
                        isLight ? "bg-[#F3EFE6] border-[#EAE5D9] text-[#78716C]" : "bg-[#080F22] border-teal-900/40 text-zinc-400"
                      }`}>
                        <div className="flex items-center gap-1.5">
                          <button
                            ...
                            className={`flex items-center gap-1.5 px-3 py-1 rounded-t-lg text-xs font-bold transition ${
                              activeFile === "main.py"
                                ? (isLight ? "bg-[#FAF8F5] text-[#D97757] border-t-2 border-[#D97757]" : "bg-[#03060E] text-teal-300 border-t-2 border-teal-400")
                        ...
                        <div className="flex items-center gap-2">
                          <button
                            ...
                            className="p-1 rounded hover:bg-zinc-200 dark:hover:bg-zinc-800 text-zinc-500 transition cursor-pointer"
                            title="Reset Code"
                          >
                            <RotateCcw size={13} />
                          </button>
                      ...
                      <div className={`flex items-center justify-between px-4 py-2 border-t text-[10px] ${
                        ...
                        <div className="flex items-center gap-3">
                          <div className={`flex items-center gap-1.5 ${isLight ? "text-[#276749]" : "text-emerald-400"}`}>
                        ...
                        <div>
                          <span>TradingView Symbol: <strong className={isLight ? "text-[#D97757]" : "text-teal-300"}>{targetAsset}</strong></span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className={`rounded-xl border p-4 font-mono shadow-inner space-y-3 ${
                      isLight ? "bg-[#F3EFE6] border-[#D9D2C5]" : "bg-[#03060F] border-teal-900/40"
                    }`}>
                      <div className={`flex items-center justify-between border-b pb-2 ${
                        isLight ? "border-[#D9D2C5]" : "border-zinc-800"
                      }`}>
                        <div className="flex items-center gap-2">
                          <button
                            ...
                            className={`px-3 py-1 rounded-lg text-xs font-bold transition ${
                              drawerTab === "terminal"
                                ? (isLight ? "bg-[#FAF8F5] text-[#D97757] border border-[#D9D2C5]" : "bg-teal-950 text-teal-300 border border-teal-700/50")
                                : "text-zinc-500 hover:text-zinc-300"
                            }`}
                          >
                        ...
                        <span className={`text-[10px] ${isLight ? "text-[#A8A29E]" : "text-zinc-500"}`}>LEAN Engine 3.11</span>
                      </div>

                      {drawerTab === "terminal" ? (
                        <div className={`h-[130px] overflow-y-auto space-y-1 text-[11px] ${
                          isLight ? "text-[#44403C]" : "text-zinc-400"
                        }`}>
                              ...
                              <span
                                className={
                                  log.includes("COMPLETED") || log.includes("DEPLOYED")
                                    ...
                                    ? (isLight ? "text-[#D97757] font-bold" : "text-teal-300")
                                    : (isLight ? "text-[#44403C]" : "text-zinc-400")
                                }
                              >
                                {log}
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs pt-1">
                          <div className={`p-2.5 rounded-lg border text-center ${
                            isLight ? "bg-[#FAF8F5] border-[#D9D2C5]" : "bg-zinc-950/80 border-zinc-800"
                          }`}>
                          ...
                          <div className={`p-2.5 rounded-lg border text-center ${
                            ...
                            <span className={`text-sm font-black ${isLight ? "text-[#D97757]" : "text-teal-300"}`}>{(btResults[0]?.sharpe || 2.52).toFixed(2)}</span>
                          </div>
                          <div className={`p-2.5 rounded-lg border text-center ${
                            isLight ? "bg-[#FAF8F5] border-[#D9D2C5]" : "bg-zinc-950/80 border-zinc-800"
                          }`}>
                            <span className={`text-[10px] block ${isLight ? "text-[#78716C]" : "text-zinc-400"}`}>Max Drawdown</span>
                            <span className="text-sm font-black text-rose-500">-{pct((btResults[0]?.max_drawdown || 0.042) * 100)}</span>
                          </div>
                          <div className={`p-2.5 rounded-lg border text-center ${
                            isLight ? "bg-[#FAF8F5] border-[#D9D2C5]" : "bg-zinc-950/80 border-zinc-800"
                          }`}>
              ...
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 font-mono">
                  ...
                  <div className={`p-5 rounded-2xl border shadow-xl space-y-1 ${
                    ...
                    <span className={`text-lg font-extrabold ${isLight ? "text-[#D97757]" : "text-teal-300"}`}>{targetAsset}</span>
                  </div>

                  <div className={`p-5 rounded-2xl border shadow-xl space-y-1 ${
                    isLight ? "bg-[#FAF8F5] border-[#EAE5D9]" : "bg-[#090F1E]/90 border-emerald-900/40"
                  }`}>
                  ...
                  <div className={`p-5 rounded-2xl border shadow-xl space-y-1 ${
                    ...
                    <span className={`text-lg font-extrabold ${isLight ? "text-[#D97757]" : "text-teal-300"}`}>2.52</span>
                  </div>
                </div>

                {/* 🔥 BADDIE FEATURE 1: INSTITUTIONAL FAMA-FRENCH 5-FACTOR ENGINE */}
                <div className={`rounded-2xl border p-6 shadow-xl space-y-4 font-mono ${
                  isLight ? "bg-[#FAF8F5] border-[#EAE5D9]" : "bg-[#090F1E]/90 border-teal-500/30"
                }`}>
                  <div className={`flex items-center justify-between border-b pb-3 ${
                    isLight ? "border-[#EAE5D9]" : "border-teal-900/30"
                  }`}>
                    <div className="flex items-center gap-2">
                      <Sparkles size={18} className={isLight ? "text-[#D97757]" : "text-teal-400"} />
                    ...
                    <span className={`text-xs px-2.5 py-0.5 rounded border ${
                      isLight ? "bg-[#E8F0EC] text-[#276749] border-[#C3DCD0]" : "bg-teal-950/80 text-teal-400 border-teal-700/50"
                    }`}>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-5 gap-3 pt-2">
                    <div className={`p-3.5 rounded-xl border space-y-1 ${
                      isLight ? "bg-[#F3EFE6] border-[#D9D2C5]" : "bg-zinc-950/80 border-zinc-800"
                    }`}>
                      ...
                      <div className={`w-full h-1 rounded-full overflow-hidden ${isLight ? "bg-[#D9D2C5]" : "bg-zinc-800"}`}>
                        <div className={`h-full w-[78%] ${isLight ? "bg-[#276749]" : "bg-emerald-400"}`} />
                      </div>
                    </div>
                    ...
                    <div className={`p-3.5 rounded-xl border space-y-1 ${
                      ...
                      <span className={`text-base font-black ${isLight ? "text-[#D97757]" : "text-teal-300"}`}>+0.84</span>
                      <div className={`w-full h-1 rounded-full overflow-hidden ${isLight ? "bg-[#D9D2C5]" : "bg-zinc-800"}`}>
                        <div className={`h-full w-[84%] ${isLight ? "bg-[#D97757]" : "bg-teal-400"}`} />
                      </div>
                    </div>
                    ...
                    <div className={`p-3.5 rounded-xl border space-y-1 ${
                      ...
                      <span className={`text-base font-black ${isLight ? "text-[#2B6CB0]" : "text-sky-400"}`}>+0.32</span>
                      <div className={`w-full h-1 rounded-full overflow-hidden ${isLight ? "bg-[#D9D2C5]" : "bg-zinc-800"}`}>
                        <div className={`h-full w-[32%] ${isLight ? "bg-[#2B6CB0]" : "bg-sky-400"}`} />
                      </div>
                    </div>
                    ...
                    <div className={`p-3.5 rounded-xl border space-y-1 ${
                      ...
                      <span className={`text-base font-black ${isLight ? "text-[#B7791F]" : "text-amber-400"}`}>+0.65</span>
                      <div className={`w-full h-1 rounded-full overflow-hidden ${isLight ? "bg-[#D9D2C5]" : "bg-zinc-800"}`}>
                        <div className={`h-full w-[65%] ${isLight ? "bg-[#B7791F]" : "bg-amber-400"}`} />
                      </div>
                    </div>
                    ...
                    <div className={`p-3.5 rounded-xl border space-y-1 ${
                      ...
                      <span className={`text-base font-black ${isLight ? "text-[#6B46C1]" : "text-purple-400"}`}>0.22</span>
                      <div className={`w-full h-1 rounded-full overflow-hidden ${isLight ? "bg-[#D9D2C5]" : "bg-zinc-800"}`}>
                        <div className={`h-full w-[22%] ${isLight ? "bg-[#6B46C1]" : "bg-purple-400"}`} />
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className={`rounded-2xl border p-6 shadow-xl space-y-4 font-mono ${
                  isLight ? "bg-[#FAF8F5] border-[#EAE5D9]" : "bg-[#090F1E]/90 border-rose-500/30"
                }`}>
                  <div className={`flex items-center justify-between border-b pb-3 ${
                    isLight ? "border-[#EAE5D9]" : "border-rose-900/30"
                  }`}>
                    <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs text-rose-500 bg-rose-100 dark:bg-rose-950/80 px-2.5 py-0.5 rounded border border-rose-300 dark:border-rose-700/50 font-bold">
                    ...
                    <button
                      ...
                      className={`px-3.5 py-2 rounded-xl text-xs font-bold border transition-all cursor-pointer ${
                        activeShockScenario === "2008 Crisis"
                          ...
                          : (isLight ? "bg-[#F0EBE1] text-[#44403C] border-[#D9D2C5]" : "bg-zinc-950 text-zinc-300 border-zinc-800")
                      }`}
                    >
                  ...
                  {activeShockScenario && (
                    <div className={`p-4 rounded-xl border text-xs space-y-2 ${
                      isLight ? "bg-[#FCE8E6] border-[#FAD2CF] text-[#1E1E1E]" : "bg-rose-950/30 border-rose-500/40 text-rose-300"
                    }`}>
                      ...
                      <div className="grid grid-cols-3 gap-3 pt-1">
                        <div className={`p-2.5 rounded-lg border ${isLight ? "bg-[#FAF8F5] border-[#EAE5D9]" : "bg-zinc-950/60 border-zinc-800"}`}>
                          <span className={`text-[10px] block ${isLight ? "text-[#78716C]" : "text-zinc-400"}`}>Projected $ P&L Impact</span>
                          <span className="text-sm font-extrabold text-rose-500">-$2,140.50 (-9.8%)</span>
                        </div>
                        <div className={`p-2.5 rounded-lg border ${isLight ? "bg-[#FAF8F5] border-[#EAE5D9]" : "bg-zinc-950/60 border-zinc-800"}`}>
                          <span className={`text-[10px] block ${isLight ? "text-[#78716C]" : "text-zinc-400"}`}>Maximum Drawdown</span>
                          <span className={`text-sm font-extrabold ${isLight ? "text-[#B7791F]" : "text-amber-400"}`}>-12.4%</span>
                        </div>
                        <div className={`p-2.5 rounded-lg border ${isLight ? "bg-[#FAF8F5] border-[#EAE5D9]" : "bg-zinc-950/60 border-zinc-800"}`}>
                ...
                <div className={`rounded-2xl border p-6 shadow-xl space-y-4 font-mono ${
                  ...
                  <div className={`flex items-center gap-2 border-b pb-3 ${
                    ...
                    <BarChart3 size={18} className={isLight ? "text-[#D97757]" : "text-teal-400"} />
