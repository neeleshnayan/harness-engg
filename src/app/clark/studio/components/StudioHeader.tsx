  ...
  return (
    <div className={`sticky top-0 z-30 border-b backdrop-blur-md transition-all ${
      isLight
        ...
        : "bg-[#040812]/90 border-emerald-500/20 text-zinc-100"
    }`}>
      <div className="mx-auto flex max-w-[1600px] flex-wrap items-center gap-3 px-6 py-3 font-mono">
        <div className="flex items-center gap-2.5">
          <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-gradient-to-br from-[#10B981] to-[#059669] shadow-sm">
