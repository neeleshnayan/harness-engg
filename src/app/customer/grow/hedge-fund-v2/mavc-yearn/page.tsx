...
export default function MAVCYearnDetailPage() {
  const router = useRouter();
  const { data: mavcYearnConfig, isLoading: configLoading } = useMAVCYearnConfig();

  console.log('🔍 MAVC Yearn Config Debug:', {
    mavcYearnConfig,
    subgraph_url: mavcYearnConfig?.subgraph_url,
    configLoading
  });
